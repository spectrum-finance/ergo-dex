...
final class SwapBox[F[_]: RuntimeState](
  ...
  override val validator: F[Boolean] =
    withRuntimeState { implicit ctx =>
      ...
      val SpectrumIsQuote: Boolean      = getConstant(7).get
      val MaxExFee: Long                = getConstant(8).get
      val BaseAmount: Long              = getConstant(12).get
      val FeeNum: Int                   = getConstant(13).get
      val PoolNFT: Coll[Byte]           = getConstant(17).get
      val RedeemerPropBytes: Coll[Byte] = getConstant(18).get
      val MinQuoteAmount: Long          = getConstant(19).get
      val ExFeePerTokenNum: Long        = getConstant(23).get
      val ExFeePerTokenDenom: Long      = getConstant(24).get
      val SpectrumId: Coll[Byte]        = getConstant(27).get
      val FeeDenom: Int                 = getConstant(29).get
      val MinerPropBytes: Coll[Byte]    = getConstant(31).get
      val MaxMinerFee: Long             = getConstant(34).get
      // Contract

...
final class SwapSellBox[F[_]: RuntimeState](
  ...
  override val validator: F[Boolean] =
    withRuntimeState { implicit ctx =>
      ...
      val ExFeePerTokenDenom: Long      = getConstant(1).get
      val Delta: Long                   = getConstant(2).get
      ...
      val MaxExFee: Long                = getConstant(11).get
      ...
      val SpectrumId: Coll[Byte]        = getConstant(23).get
      val FeeDenom: Int                 = getConstant(27).get
